...
<head>
    ...
    <link rel="icon" sizes="513x139" href="<?= asset_url('assets/img/logo.png') ?>">
</head>

<body>

    <img id="test-image" src="<?= asset_url('assets/img/back.jpg') ?>">
    <div id="main" class="container">
        <div class="wrapper row">
            <div id="book-appointment-wizard" class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                        ...
                        <div class="frame-content row">
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone-number" class="required form-control" maxlength="10" />
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="zip-code" class="form-control" maxlength="120" />
                                </div>
                                <div class="form-group">
                ...
                <div id="frame-footer">
                    Powered By
                    <a  target="_blank">EcloudSolution</a>
                    |
