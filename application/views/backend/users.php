                        ...
                        <div class="row">
                            <div class="provider-details col-xs-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="provider-phone-number" class="form-control required" max="10">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="provider-state" class="form-control" maxlength="256">
                                </div>
                    ...
                    <div class="row">
                        <div class="secretary-details col-xs-12 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="secretary-state" class="form-control" maxlength="128">
                            </div>
                    ...
                    <div class="row">
                        <div class="admin-details col-xs-12 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="admin-phone-number" class="form-control required" maxlength="10">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="admin-state" class="form-control" maxlength="128">
                            </div>
